...
var getBasketItemByProduct = function (_a) {
    ...
    if (product) {
        ...
        if (product && product.variantBySelectedOptions && product.variantBySelectedOptions !== null) {
            variantId_1 = product.variantBySelectedOptions.id;
        }
        if (product.variants) {
            variantId_1 = product.variants[0].id;
        }
        if (product.barcodes) {
            // handle & convert plain product Id from BCapp to base64
            var variationIDPlain = 'gid://shopify/ProductVariant/' + variantId_1;
            var buff = Buffer.from(variationIDPlain);
            variantId_1 = buff.toString('base64');
        }
        return currentCart.lineItems.find(function (item) { return item.variant.id === variantId_1; });
    }
    return false;
};
var params = {
    ...
    load: function (context, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var appKey, existngCartId, checkoutId, plainResp;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appKey = context.$shopify.config.app.$config.appKey;
                        existngCartId = context.$shopify.config.app.$cookies.get(appKey + '_cart_id');
    ...
    removeItem: function (context, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, context.$shopify.api.removeFromCart({ currentCart: currentCart, product: product }).then(function (checkout) {
    ...
    updateItemQty: function (context, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, context.$shopify.api.updateCart({ currentCart: currentCart, product: product, quantity: quantity }).then(function (checkout) {
                            // return updated cart data
                            return JSON.parse(JSON.stringify(checkout));
                        })];
                    case 1: 
...
var params$2 = {
    search: function (context, params) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    searchParams = __rest(params, []);
                    if (!params.ContentType) return [3 /*break*/, 4];
                    if (!(params.ContentType === 'updatePreferences')) return [3 /*break*/, 2];
                    return [4 /*yield*/, context.$shopify.api.updateNewsLetterPreferences(searchParams)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    if (!(params.ContentType === 'page')) return [3 /*break*/, 4];
                    return [4 /*yield*/, context.$shopify.api.getPages(searchParams)];
                case 3: return [2 /*return*/, _a.sent()];
                case 4: return [4 /*yield*/, context.$shopify.api.getBlogPosts(searchParams)];
                case 5: return [2 /*return*/, _a.sent()];
            }
        });
    }); }
};
var index$2 = core.useContentFactory(params$2);
...
var enhanceProduct = function (productResponse) {
    var enhancedProductResponse = productResponse.map(function (product) {
        var _a, _b, _c, _d, _e;
        return (__assign(__assign({}, product), { name: product.variantBySelectedOptions && product.variantBySelectedOptions !== null ? product.variantBySelectedOptions.title : product.title, images: product === null || product === void 0 ? void 0 : product.images, price: {
                original: product.variantBySelectedOptions && product.variantBySelectedOptions !== null ? (_b = (_a = product.variantBySelectedOptions) === null || _a === void 0 ? void 0 : _a.compareAtPriceV2) === null || _b === void 0 ? void 0 : _b.amount : product.variants[0].compareAtPrice,
                current: product.variantBySelectedOptions && product.variantBySelectedOptions !== null ? (_d = (_c = product.variantBySelectedOptions) === null || _c === void 0 ? void 0 : _c.priceV2) === null || _d === void 0 ? void 0 : _d.amount : product.variants[0].price
            }, available: product.variantBySelectedOptions && product.variantBySelectedOptions !== null ? (_e = product.variantBySelectedOptions) === null || _e === void 0 ? void 0 : _e.quantityAvailable : product.variants[0].available, productType: product.productType, options: product.options, _id: product.id, variantId: product.variants[0].id, _description: product.description, _descriptionHtml: product.descriptionHtml, _categoriesRef: [], _slug: product.handle, _coverImage: product === null || product === void 0 ? void 0 : product.images[0], _mainPrice: product.variants[0].price }));
    });
...
var index$3 = core.useFacetFactory(factoryParams);
...
var index$4 = core.useProductFactory(params$3);
...
var index$5 = core.useReviewFactory(params$4);

/* istanbul ignore file */
var params$5 = {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    load: function (context) { return __awaiter(void 0, void 0, void 0, function () {
        var appKey, token, result, customer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appKey = context.$shopify.config.app.$config.appKey;
                    token = context.$shopify.config.app.$cookies.get(appKey + '_token');
    ...
    register: function (context, _a) {
        var email = _a.email, userPassword = _a.userPassword, firstName = _a.firstName, lastName = _a.lastName;
        return __awaiter(void 0, void 0, void 0, function () {
            var result, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, context.$shopify.api.signUp({
                            email: email,
                            firstName: firstName,
                            lastName: lastName,
    ...
    logIn: function (context, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var result_1, response_1, result, response, appKey;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!(username && !password)) return [3 /*break*/, 2];
                        return [4 /*yield*/, context.$shopify.api.forgotPassword({ username: username })];
                    case 1:
                        result_1 = _d.sent();
                        response_1 = {
                            token: 'forgotPassword',
                            error: ((_c = (_b = result_1 === null || result_1 === void 0 ? void 0 : result_1.customerRecover) === null || _b === void 0 ? void 0 : _b.customerUserErrors[0]) === null || _c === void 0 ? void 0 : _c.message) || ''
                        };
                        return [2 /*return*/, response_1];
                    case 2: return [4 /*yield*/, context.$shopify.api.signIn({ username: username, password: password })];
                    case 3:
                        result = _d.sent();
                        response = {
    ...
    changePassword: function (context, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var appKey, token, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appKey = context.$shopify.config.app.$config.appKey;
                        token = context.$shopify.config.app.$cookies.get(appKey + '_token');
                        return [4 /*yield*/, context.$shopify.api.changePassword({ token: token, newPassword: newPassword })];
                    case 1:
                        result = _b.sent();
...
var index$6 = core.useUserFactory(params$5);
...
var params$6 = {
    addAddress: function (context, params) { return __awaiter(void 0, void 0, void 0, function () {
        var appKey, token, formatedAddress, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appKey = context.$shopify.config.app.$config.appKey;
                    ...
                    return [4 /*yield*/, context.$shopify.api.addAddress({ token: token, address: formatedAddress })];
                case 1:
                    result = _a.sent();
                    if (result) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appKey = context.$shopify.config.app.$config.appKey;
                    token = context.$shopify.config.app.$cookies.get(appKey + '_token');
                    return [4 /*yield*/, context.$shopify.api.deleteAddress({ token: token, AddressId: params.address.id })];
                case 1:
                    result = _a.sent();
                    if (result) {
                        if (result.customerUserErrors.length === 0) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, context.$shopify.api.updateAddress({ token: token, AddressId: params.address.id, address: formatedAddress })];
                case 1:
                    result = _a.sent();
                    if (result) {
                        if (result.customerUserErrors.length === 0) {
    ...
    load: function (context, params) { return __awaiter(void 0, void 0, void 0, function () {
        var appKey, token, result, addresses;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appKey = context.$shopify.config.app.$config.appKey;
...
var index$8 = core.useUserOrderFactory(params$7);
...
var findBiggestId = function () { return addresses$1.reduce(function (highest, _a) {
    var id = _a.id;
...
var index$9 = core.useUserShippingFactory(params$8);
...
var index$a = core.useWishlistFactory(params$9);
...
var getCartItemId = function (product) { return product.id || '0'; };
var getCartItemSlug = function (product) {
    return product.slug || '0';
};
// eslint-disable-next-line @typescript-eslint/no-unused-vars
var getCartItemImage = function (product) {
    var _a, _b, _c, _d, _e;
    if (product.variant && ((_a = product === null || product === void 0 ? void 0 : product.variant) === null || _a === void 0 ? void 0 : _a.image) !== null) {
        var imgPath = (_c = (_b = product === null || product === void 0 ? void 0 : product.variant) === null || _b === void 0 ? void 0 : _b.image) === null || _c === void 0 ? void 0 : _c.src.substring(0, product === null || product === void 0 ? void 0 : product.variant.image.src.lastIndexOf('.'));
        var imgext = (_e = (_d = product === null || product === void 0 ? void 0 : product.variant) === null || _d === void 0 ? void 0 : _d.image) === null || _e === void 0 ? void 0 : _e.src.split('.').pop();
        var cartImg = imgPath + '_120x120.' + imgext;
        return cartImg;
    }
    return '';
};
...
var getCartItemPrice = function (product) {
    return {
        regular: (product === null || product === void 0 ? void 0 : product.variant.compareAtPrice) || null,
        special: (product === null || product === void 0 ? void 0 : product.variant.price) || null
    };
};
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
var getCartItemSku = function (product) { return (product === null || product === void 0 ? void 0 : product.variant.sku) || '-'; };
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
var getCartTotalItems = function (cart) {
    if (cart) {
        return cart.lineItems.reduce(function (n, _a) {
...
var buildFacets = function (searchData, reduceFn, criteria) {
    if (!(searchData === null || searchData === void 0 ? void 0 : searchData.data)) {
        return [];
    }
...
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
var getCurrentPage = function (searchData) {
    var _a;
    return ((_a = searchData === null || searchData === void 0 ? void 0 : searchData.input) === null || _a === void 0 ? void 0 : _a.page) || 1;
};
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
var getProductDiscountPercentage = function (product) {
    var _a, _b;
    var regular = parseFloat((_a = product === null || product === void 0 ? void 0 : product.price) === null || _a === void 0 ? void 0 : _a.original) || 0;
    var special = parseFloat((_b = product === null || product === void 0 ? void 0 : product.price) === null || _b === void 0 ? void 0 : _b.current) || 0;
    if (special < regular) {
        var discount = regular - special;
        var discountPercentage = (discount / regular) * 100;
...
var getProductGallery = function (product) {
    return (product ? product.images : [])
        .map(function (image) {
        var imgPath = image.originalSrc.substring(0, image.originalSrc.lastIndexOf('.'));
        var imgext = image.originalSrc.split('.').pop();
        var imgSmall = imgPath + '_160x160.' + imgext;
        var imgBig = imgPath + '_295x295.' + imgext;
        var imgNormal = imgPath + '_600x600.' + imgext;
        return ({
            small: imgSmall,
            big: imgBig,
            normal: imgNormal
...
var getActiveVariantImage = function (product) {
    if (product) {
        var productImg = product._coverImage.originalSrc;
...
var getFilteredSingle = function (product) {
    if (!product) {
        return [];
    }
...
var getProductAttributes = function (products, filterByAttributeName) {
    ...
    var reduceByAttributeName = function (prev, curr) {
        var _a;
        return (__assign(__assign({}, prev), (_a = {}, _a[capitalize(curr.name)] = isSingleProduct ? curr.value : __spreadArrays((prev[curr.name] || []), [
            {
                value: curr.value,
                label: curr.label
            }
...
var getProductVariantId = function (product) { var _a; return ((_a = product) === null || _a === void 0 ? void 0 : _a.variants[0].id) || ''; };
var getProductId = function (product) { var _a; return ((_a = product) === null || _a === void 0 ? void 0 : _a._id) || ''; };
var getProductOriginalId = function (product) {
    if (product && (product === null || product === void 0 ? void 0 : product._id)) {
        var buff = Buffer.from(product === null || product === void 0 ? void 0 : product._id, 'base64');
        var decodedId = buff.toString('ascii');
        var extractedInfo = decodedId.split(/[\s/]+/).pop();
...
var getProductSaleStatus = function (product) {
    if (product && (product.availableForSale)) {
        return true;
    }
    return false;
};
var getProductCoverImage = function (product, size) {
    if (size === void 0) { size = 'normal'; }
    var imgResolution = '600x600';
    if (size === 'medium') {
    ...
    if (product && product._coverImage && product._coverImage.src) {
        var imgPath = product._coverImage.src.substring(0, product._coverImage.src.lastIndexOf('.'));
        var imgext = product._coverImage.src.split('.').pop();
        var resizedImg = imgPath + '_' + imgResolution + '.' + imgext;
        return resizedImg;
    }
    return 'https://cdn.shopify.com/s/files/1/0407/1902/4288/files/placeholder_' + imgResolution + '.jpg?v=1625742127';
};
var getProductCollections = function (product, field) {
    if (field === void 0) { field = 'all'; }
    if (!product) {
        return;
    }
    if (product.collections && Object.keys(product.collections).length > 0) {
        var collections_1 = [];
        Object.values(product.collections).map(function (collection) {
            if (field === 'all') {
                collections_1.push({
                    id: collection.id,
                ...
                collections_1.push(collection[field]);
            }
        });
...
var getPDPProductCoverImage = function (product, size) {
    if (size === void 0) { size = 'normal'; }
    var imgResolution = '600x600';
    if (size === 'medium') {
        imgResolution = '295x295';
    ...
    if (product && product._coverImage && product._coverImage.originalSrc) {
        var imgPath = product._coverImage.originalSrc.substring(0, product._coverImage.originalSrc.lastIndexOf('.'));
        var imgext = product._coverImage.originalSrc.split('.').pop();
        var resizedImg = imgPath + '_' + imgResolution + '.' + imgext;
        return resizedImg;
    }
    return 'https://cdn.shopify.com/s/files/1/0407/1902/4288/files/placeholder_' + imgResolution + '.jpg?v=1625742127';
};
var getProductStockStatus = function (product) {
    if (product && product.variantBySelectedOptions && product.variantBySelectedOptions !== null) {
...
var getProductStock = function (product) {
    if (product && product.variantBySelectedOptions && product.variantBySelectedOptions !== null) {
...
var productGetters = {
    ...
    getFilteredSingle: getFilteredSingle,
    getProductOriginalId: getProductOriginalId,
...
var getAcceptsMarketingStatus = function (user) {
    if (user) {
        return (user === null || user === void 0 ? void 0 : user.acceptsMarketing) || false;
    }
    return false;
};
var getUserCleanId = function (user) {
    if (user && user.id) {
        var buff = Buffer.from(user.id, 'base64');
        var decodedId = buff.toString('ascii');
        var extractedInfo = decodedId.split(/[\s/]+/).pop();
        return extractedInfo;
    }
...
var getUserToken = function (user) { return (user === null || user === void 0 ? void 0 : user.token) || ''; };
var getUserTags = function (user) {
    if (user && user.tags && user.tags.length > 0) {
        var tagsList = (user === null || user === void 0 ? void 0 : user.tags).map(function (tag) {
            return tag.value;
        });
...
var getUserPhone = function (user) { return (user === null || user === void 0 ? void 0 : user.phone) || ''; };
var getUserdisplayName = function (user) { return (user === null || user === void 0 ? void 0 : user.displayName) || ''; };
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
var getUserdefaultAddress = function (user) {
...
var getTrackingUrl = function (order) {
    if (order.fulfillmentStatus === 'FULFILLED' && order.successfulFulfillments[0].trackingInfo.length > 0) {
...
var getShippingPrice = function (order) { return order.totalShippingPriceV2.amount || 0; };
var getShippingAddress = function (order) {
    var _a;
    if (order.shippingAddress) {
        return ((_a = order === null || order === void 0 ? void 0 : order.shippingAddress) === null || _a === void 0 ? void 0 : _a.formatted) || 'No shipping address available';
    }
    return 'No shipping address available';
};
var getCustomerName = function (order) { var _a; return ((_a = order === null || order === void 0 ? void 0 : order.shippingAddress) === null || _a === void 0 ? void 0 : _a.name) || ' - '; };
var getCustomerPhone = function (order) { var _a; return ((_a = order === null || order === void 0 ? void 0 : order.shippingAddress) === null || _a === void 0 ? void 0 : _a.phone) || ''; };
// eslint-disable-next-line @typescript-eslint/no-unused-vars
var getItems$1 = function (order) { return order.lineItems || []; };
// eslint-disable-next-line @typescript-eslint/no-unused-vars
var getItemSku = function (item) { return (item === null || item === void 0 ? void 0 : item.variant.sku) || '-'; };
var getItemImage = function (item) {
    if (item && (item === null || item === void 0 ? void 0 : item.variant.image)) {
        var imgPath = item === null || item === void 0 ? void 0 : item.variant.image.originalSrc.substring(0, item === null || item === void 0 ? void 0 : item.variant.image.originalSrc.lastIndexOf('.'));
        var imgext = item === null || item === void 0 ? void 0 : item.variant.image.originalSrc.split('.').pop();
        var resizedImg = imgPath + '_100x100.' + imgext;
        return resizedImg;
    }
...
exports.useContent = index$2;
exports.useFacet = index$3;
exports.useProduct = index$4;
exports.useReview = index$5;
exports.useUser = index$6;
exports.useUserBilling = index$7;
exports.useUserOrders = index$8;
exports.useUserShipping = index$9;
exports.useWishlist = index$a;
