    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                exports.Logger.error("api." + functionObject.fnName, err_1);
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
                return [7 /*endfinally*/];
    ...
    return function useSearch(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useSearch/" + id + "/search", searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useSearch/" + id + "/search", err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
